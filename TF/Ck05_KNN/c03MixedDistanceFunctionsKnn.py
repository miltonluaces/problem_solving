...
subtraction_term =  tf.sub(Xdata_train, tf.expand_dims(Xdata_test,1))
first_product = tf.batch_matmul(subtraction_term, tf.tile(tf.expand_dims(weight_matrix,0), [bSize,1,1]))
