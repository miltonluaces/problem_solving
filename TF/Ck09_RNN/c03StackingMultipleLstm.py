...
class LSTM_Model():
    def __init__(self, rnn_size, num_layers, bSize, learning_rate,
...
with tf.variable_scope('lstm_model') as scope:
    # Define LSTM Model
    lstm_model = LSTM_Model(rnn_size, num_layers, bSize, learning_rate,
                            training_seq_len, vocab_size)
    scope.reuse_variables()
    test_lstm_model = LSTM_Model(rnn_size, num_layers, bSize, learning_rate,
