...
def max_pool(input_1d, width):
    ...
    # [bSize=1, width=1, height=num_input, channels=1]
    input_2d = tf.expand_dims(input_1d, 0)
    input_3d = tf.expand_dims(input_2d, 0)
    input_4d = tf.expand_dims(input_3d, 3)
...
myMaxpool_output = max_pool(my_activation_output, width=5)
...
my_full_output = fully_connected(myMaxpool_output, 5)
...
print(sess.run(myMaxpool_output, feed_dict=feed_dict))
...
def max_pool(input_2d, width, height):
    # Just like 'conv2d()' above, max_pool() works with 4D arrays.
    # [bSize=1, width=given, height=given, channels=1]
    input_3d = tf.expand_dims(input_2d, 0)
    input_4d = tf.expand_dims(input_3d, 3)
    # Perform the max pooling with strides = [1,1,1,1]
    # If we wanted to increase the stride on our data dimension, say by
...
myMaxpool_output = max_pool(my_activation_output, width=2, height=2)
